    ...
    public partial class Form1 : Form
    {
        ...
        private void NotifyIcon_Click(object sender, EventArgs e)
        {
            if (isMetal == false)
            {
                ...
                notifyIcon.Icon = Icon = Icon.FromHandle(Properties.Resources.Sabaton_S_Logo.GetHicon());
                return;
            }
            else
            {
                ...
                isMetal = false;
                notifyIcon.Text = "Click to toggle modes | Current: Standard";
                notifyIcon.Icon = Icon = Icon.FromHandle(Properties.Resources.high_volume.GetHicon());
                return;
            }
        }
